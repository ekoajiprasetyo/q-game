...
@section('title', 'Edit Materi - ' . $material->name)
...
@section('content')
    ...
    <div class="page-header">
        <div class="page-header-content">
            <div>
                ...
                <h1 class="page-title">
                    <div class="page-title-icon">{{ $material->icon ?? '📄' }}</div>
                    Edit Materi
                </h1>
                <p class="page-subtitle">{{ $material->name }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="card" style="max-width: 600px;">
        <div class="card-body">
            <form action="{{ route('admin.topics.materials.update', [$topic, $material]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex gap-3">
                    ...
                    <div class="form-group" style="flex: 1;">
                        ...
                        <input 
                            ...
                            name="color" 
                            class="form-control" 
                            value="{{ old('color', $material->color ?? '#B47EFF') }}"
